...
export default function LegalPage() {
  return (
    <>
      {/* HERO */}
      <section className="border-b border-border bg-mvcb-cream py-14">
        <div className="mx-auto max-w-6xl px-6 sm:px-8">
          <span className="text-xs font-semibold tracking-wide text-mvcb-orange-strong uppercase">
            Legal Information
          </span>
          <h1 className="mt-3 text-3xl font-black tracking-tight text-mvcb-black md:text-4xl">
            Privacy Policy
          </h1>
            ...
            <ul className="mt-4 flex flex-col gap-3 text-sm">
              {SECTIONS.map((section) => (
                <li key={section.id}>
                  <a
                    href={`#${section.id}`}
                    className="text-muted-foreground hover:text-mvcb-orange-strong"
                  >
                    {section.title}
                  </a>
                </li>
          ...
          <div className="flex flex-1 flex-col gap-10">
            <div id="information-we-collect">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                We collect the information needed to plan projects and
                respond to inquiries: your name, email, phone number,
                project site address, and details relevant to permitting
                with the NJ Division of Consumer Affairs.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                We also use cookies and basic site analytics to see how
                visitors use the site and to manage incoming quote requests.
              </p>
            </div>
            ...
            <div id="how-we-use-it">
              ...
              <ul className="mt-3 flex flex-col gap-2 pl-5 text-sm leading-relaxed text-muted-foreground [&>li]:list-disc">
                ...
                <li>
                  Communicate with you about scheduling and project
                  updates.
                </li>
              </ul>
            </div>
            ...
            <div id="third-party-sharing">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                companies. We share it only with subcontractors
                (electricians, HVAC technicians, surveyors) when it&apos;s
                necessary to complete a project, and only the details they
                need to do their part of the work.
              </p>
            </div>
            ...
            <div id="security">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                We store client information behind standard access
                controls and limit who on our team can view it. Only
                office staff and the project lead working on your job have
            ...
            <div id="contact">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                For questions about this policy, contact our Belleville
                office:
              </p>
