...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html lang="en" className={`${jakartaSans.variable} h-full antialiased`}>
      ...
      {/* Also set NEXT_PUBLIC_GA_MEASUREMENT_ID and NEXT_PUBLIC_CLARITY_PROJECT_ID
          in the hosting provider's env vars (e.g. Vercel) before deploying,
          same as the EmailJS keys. */}
